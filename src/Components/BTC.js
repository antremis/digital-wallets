...
const BTC = () => {
    ...
    return(
        <>
            <ChainInfo refresh = {getBTC} handeModalChange = {handeModalChange} currency = "BTC" balance = {BTC?.balance} value = {(prices?.BTC*BTC?.balance).toFixed(5)} address = {BTC?.address} history = {BTC?.history} txuri = "https://www.blockchain.com/btc-testnet/tx/" adduri = "https://www.blockchain.com/btc-testnet/address/" />
