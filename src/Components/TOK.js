...
const Tokens = () => {
    ...
    const {ETH, TOK, prices} = useUserContext()
        ...
        <>
            <div style = {styles.Container} >
                ...
                <div style = {styles.CardWrapper} >
                    {
                        TOK?.map((item, index) => (
                            <a key = {index} data-attribute = "asset-card" style = {styles.Card} target = "_blank" rel="noreferrer" href = {`https://rinkeby.etherscan.io/token/${item.address}`}>
